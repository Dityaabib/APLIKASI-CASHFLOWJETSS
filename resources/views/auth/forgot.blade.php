...
<head>
    ...
    <title>Lupa Kata Sandi - {{ config('app.name', 'CashFlow') }}</title>
    ...
    <div class="flex min-h-screen items-center justify-center px-4">
        <div class="w-full max-w-md">
            <div class="text-center mb-6">
                ...
                <h1 class="mt-4 text-2xl font-semibold">Lupa Kata Sandi?</h1>
                <p class="mt-1 text-sm text-gray-600">Fitur reset kata sandi belum diaktifkan.</p>
            </div>

            <div class="bg-white shadow rounded-lg p-6">
                <p class="text-sm text-gray-700">Silakan hubungi admin untuk reset kata sandi.</p>
